...
(library Library_1
	...
	(patternDef "1935190" (originalName "1935190")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 10.285, -0.500) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 4) (pt 23.07 4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 23.07 4) (pt 23.07 -5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 23.07 -5) (pt -2.5 -5) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "1935190" (originalName "1935190") (compHeader (numPins 5) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.phoenixcontact.com/online/portal/us/pxc/product_detail_page/!ut/p/z1/3Vdbc5pAFP4r5sG3rLsLLEJn-oDGlJjEYsQqvDDssma24RZETf31Xbyk1Wn1IeN0CnNm2D2c853L8jEc6MMp9NNwKZ7DUmRpGMu95-uB23F7PUfR8dch6aC7G9LtPWhP2B4o8Bv0oV-GFHq4WsWCFmHxA3qLOU8rRS4i-chUCTZRtc")
		(attr "<Component Height>" "11.55")
		(attr "<STEP Filename>" "1935190.stp")
		(attr "<STEP Offsets>" "X=-15.12;Y=-44.67;Z=-39.03")
