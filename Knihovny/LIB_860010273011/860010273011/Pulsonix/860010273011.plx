...
//466551/1502846/2.50/2/4/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "CAPPRD250W52D630H1250" (originalName "CAPPRD250W52D630H1250")
		(multiLayer
	...
	(symbolDef "860010273011" (originalName "860010273011")
	...
	(compDef "860010273011" (originalName "860010273011") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "860010273011"))
		(attachedPattern (patternNum 1) (patternName "CAPPRD250W52D630H1250")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "710-860010273011")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Wurth-Elektronik/860010273011?qs=0KOYDY2FL28ooChuQJugtQ%3D%3D")
		(attr "Manufacturer_Name" "Wurth Elektronik")
		(attr "Manufacturer_Part_Number" "860010273011")
		(attr "Description" "Wurth Elektronik 470uF 10 V Aluminium Electrolytic Capacitor, WCAP-ATG8 Series 2000h 6.3 (Dia.) x 11mm")
		(attr "<Hyperlink>" "https://katalog.we-online.de/pbs/datasheet/860010273011.pdf")
		(attr "<Component Height>" "12.5")
		(attr "<STEP Filename>" "860010273011.stp")
